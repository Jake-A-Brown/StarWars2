const StarshipData = [
    {
        name:`CR90 corvette`,
        description:`A versatile starship, the CR90 was used extensively across the galaxy by governments and private interests. The interior of the CR90 featured a modular design to allow for easy reconfiguration of the Corellian corvette from one function to another. Some older model corvettes, like the CR70, could easily be upgraded with retrofit packages like the Vanguard c20 to become CR90s.`,
        starshipImageLink:`https://static.wikia.nocookie.net/starwars/images/2/24/TantiveIV-TSWB.png`,
    },
    {
        name:`Star Destroyer`,
        description:`The wedge-shaped Imperial Star Destroyer is a capital ship bristling with weapons emplacements. Turbolasers and tractor beam projectors dot its surface. Its belly hangar bay can launch TIE fighters, boarding craft, land assault units, hyperspace probes, or be used to hold captured craft. In the days of the Empire, its bustling bridge would be staffed by the finest crewers in the Imperial starfleet. Its presence in a system mark matters of extreme Imperial import. Though, as is typical of the Empire, not even the Star Destroyer was enough to sate the Imperial hunger for displays of power. Larger vessels, such as the Super Star Destroyer, dwarf even these giants.`,
        starshipImageLink:`https://lumiere-a.akamaihd.net/v1/images/Star-Destroyer_ab6b94bb.jpeg`,
    },
    {
        name:`Sentinel-class landing craft`,
        description:`Designed by Sienar Fleet Systems, the Sentinel-class shuttle was a larger-scale troop transport used by the Empire. Much like its cousin, the Lambda-class shuttle, these vehicles featured three wings in a triangular layout: a stationary center foil and two articulated flanking wings. Imperials used the shuttle for missions that spanned the galaxy, from a search for droids on Tatooine to conflicts with the Lothal rebels.`,
        starshipImageLink:`https://lumiere-a.akamaihd.net/v1/images/Imperial-Sentinel-Class-Shuttle_a2dc7d3b.jpeg`,
    },
    {
        name:`Death Star`,
        ...
        starshipImageLink:`https://lumiere-a.akamaihd.net/v1/images/Death-Star-I-copy_36ad2500.jpeg`,
    },
    {
        ...
        starshipImageLink:`https://lumiere-a.akamaihd.net/v1/images/millennium-falcon-main-tlj-a_7cf89d3a.jpeg`,
    },
    {
        name:`Y-wing`,
        ...
        starshipImageLink:`https://lumiere-a.akamaihd.net/v1/images/Y-Wing-Fighter_0e78c9ae.jpeg`,
    },
    {
        name:`X-wing`,
        ...
        starshipImageLink:`https://lumiere-a.akamaihd.net/v1/images/X-Wing-Fighter_47c7c342.jpeg`,
    },
    {
        ...
        starshipImageLink:`https://lumiere-a.akamaihd.net/v1/images/vaders-tie-fighter_8bcb92e1.jpeg`,
    },
    {
        name:`Executor`,
        ...
        starshipImageLink:`https://lumiere-a.akamaihd.net/v1/images/databank_executor_01_169_8157df82.jpeg`,
    },
    {
        name:`Rebel transport`,
        description:`A military version of a civilian transport, the GR-75 proved critical to the rebel retreat from Hoth, as starfighters protected personnel and equipment evacuating aboard these minimally armed craft. The GR-75’s clamshell-like outer hull offers protection for its interior, which can be filled with cargo pods.`,
        starshipImageLink:`https://lumiere-a.akamaihd.net/v1/images/gr-75-medium-transport_cd04862d.jpeg`,
    },
    {
        name:`Slave 1`,
    ...
    },
    {
        ...
        starshipImageLink:`https://lumiere-a.akamaihd.net/v1/images/databank_republiccruiser_01_169_fd769e33.jpeg`,
    },
    {
        ...
        starshipImageLink:`https://lumiere-a.akamaihd.net/v1/images/databank_tradefederationbattleship_01_169_fc5458ce.jpeg`,
    },
    {
        name:`Naboo fighter`,
        ...
        starshipImageLink:`https://lumiere-a.akamaihd.net/v1/images/databank_naboon1starfighter_01_169_26691adf.jpeg`,
    },
    {
        ...
        starshipImageLink:`https://lumiere-a.akamaihd.net/v1/images/databank_nabooroyalstarship_01_169_e61f677e.jpeg`,
    },
    {
        name:`Scimitar`,
        description:`A fittingly fearsome vessel for its deadly pilot, the Sith Infiltrator is the personal starship of Darth Maul, Dark Lord of the Sith. Maul used the sleek ship to silently travel wherever his master, Darth Sidious, ordered. The Infiltrator set down on Tatooine during the search for Queen Amidala, and became a mobile base of operations for Maul. From his starship he launched a trio of Sith probe droids to seek out the Queen and her Jedi protectors. Once found, he unloaded his swift Sith Speeder to pursue his quarry.`,
        starshipImageLink:`https://lumiere-a.akamaihd.net/v1/images/databank_sithinfiltrator_01_169_1bd0a638.jpeg`,
    },
    {
    ...
    },
    {
        ...
        starshipImageLink:`https://static.wikia.nocookie.net/starwars/images/7/70/Acclamator-TCWIV.png`,
    },
    {
        name:`Solar Sailer`,
        description:`Built by the Geonosians, Count Dooku’s Punworcca 116-class interstellar swoop was an example of a solar sailer, a beautiful and expensive ship notable for the sails it would unfurl for interstellar flight. Dooku’s solar sailer brought him from Geonosis to Coruscant after the opening battle of the Clone Wars, and he later lent solar sailers to his apprentices Asajj Ventress and Savage Opress.`,
        starshipImageLink:`https://lumiere-a.akamaihd.net/v1/images/databank_geonosiansolarsailer_01_169_b3873578.jpeg`,
    },
    {
        name:`Trade Federation cruiser`,
        description:`The Trade Federation Cruiser was a type of wedge-shaped capital ship utilized by the Trade Federation Droid Army around the time of the Clone Wars. The cruiser possessed several laser cannons but used cruise missiles as its primary weapons. One was destroyed in 22 BBY by the Lok Revenants.`,
        starshipImageLink:`https://static.wikia.nocookie.net/starwars/images/f/f1/Invincible-TCWs2BR3.png`,
    },
    {
        name:`Theta-class T-2c shuttle`,
        description:`The Theta-class T-2c shuttle, also known as the Theta-class shuttle, was a model of shuttle used by the Galactic Republic and later, the Galactic Empire. The Emperor and Sith Lord Darth Sidious ordered Grand Vizier Mas Amedda to inform Captain Kagi to prepare his Theta-class for immediate takeoff to rescue Darth Vader on Mustafar following a duel there against his former Jedi Master Obi-Wan Kenobi. The shuttle would also be used to transport a number of incarcerated Imperial senators in the aftermath of a mass arrest by Imperial Intelligence. In the early days of the Empire, a Theta-class shuttle transported Sidious and Vader to Gattering in the Mid Rim, and later transported Sidious and Vader to the Inquisitorius Headquarters in order for Vader to take command of the Inquisitorius. During the Berch Teller campaign, Moff Wilhuff Tarkin asked the captain of the Liberator for a Theta-class for transport to the Goliath.`,
        starshipImageLink:`https://static.wikia.nocookie.net/scifi/images/4/47/Imperial_Shuttle2.jpg`,
    },
    {
        name:`Republic attack cruiser`,
        description:`The Republic attack cruiser was not primarily a cargo transport, troop carrier or other replenishment or supply vessel; it was developed and honed for ship-to-ship combat. Its huge armored shape had an aggressive, dagger-like profile, studded with heavy weapons emplacements capable of punching through powerful shields and sturdy armor. The front half of the ship's spine contained a massive flight deck capable of scrambling the latest in Republic starfighters. The huge hangar doors opened to allow ships to land or takeoff from the deck; the vessel also had a smaller docking bay entrance on its lower side.`,
        starshipImageLink:`https://lumiere-a.akamaihd.net/v1/images/databank_republicattackcruiser_01_169_812f153d.jpeg`,
    },
    {
        name:`Naboo star skiff`,
        description:`The J-type star skiff symbolized the changes sweeping through the galaxy in the final days of the Galactic Republic.
    ...
    },
    {
        ...
        starshipImageLink:`https://lumiere-a.akamaihd.net/v1/images/databank_arc170starfighter_01_169_f932abcb.jpeg`,
    },
    {
        ...
        starshipImageLink:`https://static.wikia.nocookie.net/starwars/images/b/bd/ReentryCapsules-ARCT.png`,
    },
    {
        name:`Belbullab-22 starfighter`,
        description:`The Belbullab-22 starfighter was a heavy starfighter constructed by Feethan Ottraw Scalable Assemblies for the Confederacy of Independent Systems. General Grievous flew a heavily-modified and battle-worn Belbullab-22, Soulless One, during the Clone Wars.`,
        starshipImageLink:`https://static.wikia.nocookie.net/starwars/images/9/91/WatTambor-SWZ.png`,
    },
    {
        name:`V-wing`,
        description:`First deployed by the Galactic Republic during the Clone Wars, after the rise of the Empire the V-wing joins other small craft in the government's formidable defense forces. A striking silhouette, the V-wing cockpit is positioned between two ion engines that taper at the base of the craft.`,
        starshipImageLink:`https://lumiere-a.akamaihd.net/v1/images/v-wing-main_37a7dec1.jpeg`,
    },
]
