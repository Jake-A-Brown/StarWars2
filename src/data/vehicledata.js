const VehicleData = [
    {
        name:`Sand Crawler`,
        description:`Sandcrawlers are huge treaded fortresses used by Jawas as transportation and shelter. The sand-pitted vehicles, many meters in height, are equipped with a magnetic suction tube for sucking droids and scrap into their cargo chambers.`,
        vehicleImageLink:`https://lumiere-a.akamaihd.net/v1/images/sandcrawler-main_eb1b036b.jpeg`,
    },
    {
        name:`T-16 skyhopper`,
        ...
        vehicleImageLink:`https://lumiere-a.akamaihd.net/v1/images/databank_t16skyhopper_01_169_ad69e901.jpeg`,
    },
    {
    ...
    },
    {
        ...
        vehicleImageLink:`https://lumiere-a.akamaihd.net/v1/images/snowspeeder_ef2f9334.jpeg`,
    },
    {
        name:`TIE bomber`,
        description:`The Empire uses flights of its specialized double-hulled TIE bombers to drop vast quantities of munitions on rebellious planets and targets in space, delivering devastating attacks with frightening accuracy. `,
        vehicleImageLink:`https://lumiere-a.akamaihd.net/v1/images/tie-bomber-main_d4d9b979.jpeg`,
    },
    {
        name:`AT-AT`,
        ...
        vehicleImageLink:`https://lumiere-a.akamaihd.net/v1/images/AT-AT_89d0105f.jpeg`,
    },
    {
        name:`AT-ST`,
        description:`While not as imposing as its larger AT-AT walker cousin, the AT-ST nonetheless served as a significant addition to the Imperial side of battlefields in the Galactic Civil War. The two-man craft is lightly armed with chin-mounted laser cannons, and side-mounted weapon pods. The two-legged transport, dubbed the scout walker by many, serves as a reconnaisance and patrol vehicle, often flanking approaching AT-ATs and mopping up infantry that sneaks past the larger walkers. The Imperials used AT-STs in both the Battle of Hoth and the Battle of Endor.`,
        vehicleImageLink:`https://lumiere-a.akamaihd.net/v1/images/e6d_ia_5724_a150e6d4.jpeg`,
    },
    {
        name:`Storm IV Twin-Pod cloud car`,
        description:`These brick-colored atmospheric vehicles keep the peace in the skies of Bespin. Cloud cars feature twin “pods” connected by a repulsorlift engine, and are equipped with light blaster cannons. Each cloud car has a pilot and a gunner, who work in tandem to intercept starships bound for Cloud City, question their captains and take defensive measures as needed.`,
        vehicleImageLink:`https://lumiere-a.akamaihd.net/v1/images/cloud-car-main-image_8d2e4e89.jpeg`,
    },
    {
        name:`Sail barge`,
        description:`Jabba the Hutt valued money and power, and enjoyed showing off just how much he had of both. The Khetanna, his luxury sail barge, was among the crimelord’s most extravagant purchases: a massive transport that carried up to 500 passengers, maintained a crew of 26, and was outfitted with space for live music and entertainment. It was manufactured by Ubrikkian, measuring 30 meters long and equipped with a heavy blaster cannon -- an essential feature for Jabba’s lifestyle. Indeed, the craft was symbolic of Jabba’s hubris and ego, and played a large part in his downfall.`,
        vehicleImageLink:`https://lumiere-a.akamaihd.net/v1/images/open-uri20150608-27674-168ubjg_976dbf1d.jpeg`,
    },
    {
        name:`Bantha-II cargo skiff`,
        description:`The Bantha-II cargo skiff was a common repulsor-based transport outside the Republic (and later the Empire.) They were extremely durable making them an austere choice for desert climes and perfect transports for passengers, cargo, or slaves for the Hutt Crime Syndicate or the slave traders of Zygerria. They were little more than floating platforms, and easily identified by their rust coloring, reinforced bows, and intermittent guard-rails around the perimeter. They came equipped with planks, making them the preferred execution conveyance for the vile gangster Jabba the Hutt, who loved to drop his enemies into pits full of monsters. Shortly before his untimely demise, Jabba forced Luke Skywalker to walk a skiff’s plank over the Great Pit of Carkoon. That was the last mistake he ever made.`,
        vehicleImageLink:`https://lumiere-a.akamaihd.net/v1/images/skiff_9d81647a.jpeg`,
    },
    {
        name:`TIE/IN interceptor`,
        description:`Faster and better-armed descendents of regular TIE fighters, TIE interceptors defended the second Death Star at the Battle of Endor. The bent-winged fighters swarmed the Rebel fleet in a terrifying display of the Empire's military might.`,
        vehicleImageLink:`https://lumiere-a.akamaihd.net/v1/images/tie-interceptor-2_b2250e79.jpeg`,
    },
    {
        name:`Imperial Speeder Bike`,
        description:`Speeder bikes are common sights throughout the galaxy, with manufacturers turning out both civilian and military models. One of the best-known speeder bikes is the Aratech 74-Z, which saw service during the Clone Wars and remained a mainstay of Imperial forces during the Galactic Civil War. All speeder bikes are capable of high-speed travel and require skill and fast reflexes.`,
        vehicleImageLink:`https://lumiere-a.akamaihd.net/v1/images/74zbike-bio-4_1609ab51.jpeg`,
    },
    {
        name:`Vulture Droid`,
        ...
        vehicleImageLink:`https://lumiere-a.akamaihd.net/v1/images/databank_vulturedroid_01_169_6ef9fd50.jpeg`,
    },
    {
        name:`Multi-Troop Transport`,
        description:`A terrifying display of Trade Federation efficiency, the mammoth MTT (Multi Troop Transport) is an armored giant capable of disgorging over a hundred battle droid soldiers into the thick of combat. The vehicle's bulbous armored front end opens to reveal an articulated deployment rack, upon which rest dozens of compressed battle droids. The rack extends forward and deposits the droids into neatly organized rows. Upon activation from an orbiting Droid Control Ship, the droids unfold into their humanoid configuration. During the Clone Wars, the Separatist Army used MTTs in Confederacy livery to transport their infantry troops to many battlefields.`,
        vehicleImageLink:`https://lumiere-a.akamaihd.net/v1/images/databank_mtt_01_169_efb8a98a.jpeg`,
    },
    {
        ...
        vehicleImageLink:`https://lumiere-a.akamaihd.net/v1/images/databank_aatbattletank_01_169_9de46aea.jpeg `,
    },
    {
        name:`Single Trooper Aerial Platform`,
        description:`STAPs are lightweight reconnaissance and patrol vehicles used by the battle droids of the Trade Federation army (and later, the Separatist Alliance). Incorporating repulsorlift technology, the STAP (single trooper aerial platform) is a slim, agile craft sporting a pair of blaster cannons. STAPs are often deployed as support vehicles in conjunction with larger craft.`,
        vehicleImageLink:`https://lumiere-a.akamaihd.net/v1/images/databank_stap_01_169_75029522.jpeg`,
    },
    {
        name:`C-9979 landing craft`,
        description:`With its huge wingspan and imposing boot-shaped loading ramp, the Trade Federation landing ship was a daunting sight. Once the immense vessels set down on a clear and secured landing field, they disgorged AATs, MTTs, troop transports and battle droids into the battlefield. These vessels saw heavy use in the military of the Separatist Alliance.`,
        vehicleImageLink:`https://lumiere-a.akamaihd.net/v1/images/databank_tradefederationlandingship_01_169_00567a01.jpeg`,
    },
    {
        ...
        vehicleImageLink:`https://lumiere-a.akamaihd.net/v1/images/databank_gunganbongosubmarine_01_169_fc9286be.jpeg`,
    },
    {
        name:`Sith speeder`,
    ...
    },
    {
        ...
        vehicleImageLink:`https://static.wikia.nocookie.net/starwars/images/e/e5/Forward_Command_Center_AotC.png`,
    },
    {
        name:`AT-TE`,
        ...
        vehicleImageLink:`https://lumiere-a.akamaihd.net/v1/images/at-te-main_09471f2b.jpeg`,
    },
    {
        name:`SPHA`,
        description:`These twelve-legged gun platforms are the largest ground based weapons in the arsenal of the Republic army. It takes no less than 30 clone troopers to man the monstrous turbolaser beams, but they are powerful and effective enough to blast through starship shields and hulls.`,
        vehicleImageLink:`https://lumiere-a.akamaihd.net/v1/images/self-propelled-heavy-artillery-turbolaser_1d69d1e5.jpeg`,
    },
    {
        name:`Flitknot speeder`,
        description:`This speederbike was a favorite of Count Dooku’s. Sometimes referred to as a “Flitknot Speeder,” these bikes are fast and maneuverable, able to outrun Republic gunships. Dooku used one to escape the first battle of Geonosis and make it back to his Solar Sailer to fight another day. They are of simple design, with more bulk at the back in the engines than anywhere else. They have two handholds and two footholds, making them perfect for bipeds.`,
        vehicleImageLink:`https://lumiere-a.akamaihd.net/v1/images/count-dookus-speeder_099a9e27.jpeg`,
    },
    {
        name:`Neimoidian shuttle`,
        description:`For transit from their enormous Trade Federation battleships to the surface of their economically or militarily conquered worlds, Neimoidian officials travel in a distinctively shaped Neimoidian escort shuttle. Curved insect-like landing gears lower from the ship's belly, giving the craft's legs a pincer-like appearance as it settles on a landing pad.`,
        vehicleImageLink:`https://lumiere-a.akamaihd.net/v1/images/neimoidian_escort_shuttle_7602d574.jpeg`,
    },
    {
        ...
        vehicleImageLink:`https://lumiere-a.akamaihd.net/v1/images/geonosian-fighter_119560e5.jpeg`,
    },
    {
        name:`Tsmeu-6 personal wheel bike`,
        description:`Lightning-quick, the TSMEU-6 wheel bike was General Grievous’ vehicle of choice during the Separatist invasion of Utapau. As its name implied, the wheel bike featured a large wheel which would spin and give the transport its fast movement and maneuverability. The TSMEU-6 was a single-passenger vehicle, with one seat next to its wheel, and could reach speeds of up to 330 kilometers per hour when rolling, and 10 kilometers per hour when running on its retractable legs. It also had significant firepower, with a powerful double laser cannon. Despite this functionality, Grievous’ wheel bike would be destroyed during a failed attempt to flee from Obi-Wan Kenobi in one of the last battles of the Clone Wars.`,
        vehicleImageLink:`https://lumiere-a.akamaihd.net/v1/images/ep3_ia_96565_46396938.jpeg`,
    },
    {
        name:`Emergency Firespeeder`,
        description:`The emergency firespeeder was a specialized airspeeder designed to put out fires. `,
        vehicleImageLink:`https://static.wikia.nocookie.net/starwars/images/6/66/Fire_ship.jpg`,
    },
    {
        name:`Droid tri-fighter`,
        description:`The droid tri-fighter was a model of droid starfighter utilized by the Confederacy of Independent Systems during the Clone Wars. It was specifically designed to engage and excel in heavy dogfighting. Despite being the smallest starship in both the Republic Navy and Confederacy navy, the tri-fighter was heavily armed, and possessed an advanced droid brain, which gave it an advantage when dealing with organic pilots. These droid brains were more advanced than those intergrated in various other droid starfighters manufactured for the Confederacy. Conceived for the total destruction of an enemy, it possessed an array of missiles and other armaments.`,
        vehicleImageLink:`https://static.wikia.nocookie.net/starwars/images/a/a0/DroidTriFighterSquadron-SWM.png`,
    },
    {
        name:`Oevvaor jet catamaran`,
        description:`The catamaran was named for the oevvaor, a predatory marine reptile that prowled the coasts of Kashyyyk. The hulls of the craft were very tough, as they were handcrafted from the wood of wroshyr trees.
        ...
        vehicleImageLink:`https://static.wikia.nocookie.net/starwars/images/6/60/Wookieeflyingcat.jpg`,
    },
    {
        name:`Raddaugh Gnasp fluttercraft`,
        description:`The Raddaugh Gnasp fluttercraft was a well-known Wookiee vehicle manufactured by Appazanna Engineering Works. The fluttercraft were used by Wookiee soldiers during the Clone Wars, and saw action during the Battle of Kashyyyk.`,
        vehicleImageLink:`https://static.wikia.nocookie.net/starwars/images/d/dc/Catamaran.jpg`,
    },
    {
        name:`Clone turbo tank`,
        description:`Inspired by the turbo tanks of the Clone Wars, the Empire created immense transports called Juggernauts. The Juggernauts move cargo and prisoners across rough terrain on enormous wheels, protecting passengers with thick armor.`,
        vehicleImageLink:`https://lumiere-a.akamaihd.net/v1/images/juggernaut-transport-vehicle-main_09946f42.jpeg`,
    },
    {
        ...
        vehicleImageLink:`https://lumiere-a.akamaihd.net/v1/images/nr_n99_persuader_class_tank_droid_f910aac1.jpeg`,
    },
    {
        name:`Droid gunship`,
        description:`Debuting late in the Clone Wars was this powerful automated predator, a heavily armed and ray-shielded air support unit capable of wiping out infantry and armor units in relentless barrages of explosive ordnance. The underside of the gunship's flat fuselage carries two clusters of missile pods, and can be fitted with droid deployment racks for insertion and extraction into the heaviest combat zones.`,
        vehicleImageLink:`https://lumiere-a.akamaihd.net/v1/images/droid_gunship_20546779.jpeg`,
    },
    {
        name:`AT-RT`,
        description:`While clone troopers were best deployed in large numbers, articulated battlefield armor such as this Republic scout walker transformed a single clone trooper into a formidable anti-infantry unit. Designed primarily as a reconnaissance vehicle, this two-legged open-cockpit walker is nonetheless swift and heavily armed, letting a clone trooper cut through battle droids easily. It was employed in such campaigns as the Battle of Kashyyyk. It was the precursor to the All Terrain Scout Transport seen during the Galactic Civil War.`,
        vehicleImageLink:`https://lumiere-a.akamaihd.net/v1/images/databank_atrtwalker_01_169_dc4f22ad.jpeg`,
    },
]
